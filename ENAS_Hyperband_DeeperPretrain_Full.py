...
# --------------------------------------------
# 📦 Load CIFAR-10 Batches (locally stored)
# --------------------------------------------
...
# --------------------------------------------
# 🔁 STEP 1: Pre-train a deeper CNN on CIFAR-10
# --------------------------------------------
...
print("✅ Pretraining complete and model saved.")

# --------------------------------------------
# 🔍 STEP 2: ENAS with Hyperband using pretrained backbone
# --------------------------------------------
def build_model(hp):
...
print("🔍 Starting Hyperband-based NAS search...")
tuner = kt.Hyperband(
    build_model,
...
# --------------------------------------------
print("🏁 Retraining best model from NAS search...")
